...
public class PathFinder : GSingleton<PathFinder>
{
    ...
    {
        StartCoroutine(DelayFindPath_Astar(0.2f));
    }           //FindPath_Astar()
    ...
    private IEnumerator DelayFindPath_Astar(float delay_)
    {
        ...
        // TODO : 알고리즘 정상 작동 확인 후 조건문 수정할 예정.
        //while (loopIdx < 30)
